...
--               /home/benny/work/fpga/vivado/i2s2_2/Pmod-I2S2-Arty-S7-50.gen/sources_1/bd/reciever/ip/reciever_phase_provider_0_0/reciever_phase_provider_0_0_sim_netlist.vhdl
...
entity reciever_phase_provider_0_0_phase_provider is
  port (
  ...
  attribute ORIG_REF_NAME of reciever_phase_provider_0_0_phase_provider : entity is "phase_provider";
end reciever_phase_provider_0_0_phase_provider;

architecture STRUCTURE of reciever_phase_provider_0_0_phase_provider is
  ...
  signal timer_reg : STD_LOGIC_VECTOR ( 12 downto 0 );
  ...
  signal \NLW_timer_reg[12]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_timer_reg[12]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
...
\counter[25]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\counter[25]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\counter_reg[25]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 2) => B"00",
      S(1) => \counter[25]_i_5_n_0\,
      S(0) => \counter[25]_i_6_n_0\
    );
...
\timer_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 0) => \NLW_timer_reg[12]_i_1_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 1) => \NLW_timer_reg[12]_i_1_O_UNCONNECTED\(3 downto 1),
...
entity reciever_phase_provider_0_0 is
  ...
  attribute NotValidForBitStream of reciever_phase_provider_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of reciever_phase_provider_0_0 : entity is "reciever_phase_provider_0_0,phase_provider,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of reciever_phase_provider_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of reciever_phase_provider_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of reciever_phase_provider_0_0 : entity is "phase_provider,Vivado 2023.2";
end reciever_phase_provider_0_0;

architecture STRUCTURE of reciever_phase_provider_0_0 is
...
inst: entity work.reciever_phase_provider_0_0_phase_provider
     port map (
      axis_clk => axis_clk,
