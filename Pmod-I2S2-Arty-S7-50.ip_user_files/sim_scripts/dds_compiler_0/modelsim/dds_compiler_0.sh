...
#
# Script generated by Vivado on Mon Apr 29 20:45:18 EEST 2024
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/benny/work/fpga/vivado/i2s2_2/Pmod-I2S2-Arty-S7-50.cache/compile_simlib/modelsim"
  fi
