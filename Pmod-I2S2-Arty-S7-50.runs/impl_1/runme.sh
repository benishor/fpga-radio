...
HD_PWD='/home/benny/work/fpga/vivado/i2s2_2/Pmod-I2S2-Arty-S7-50.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reciever_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reciever_wrapper.tcl -notrace
