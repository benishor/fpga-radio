...
HD_PWD='/home/benny/work/fpga/vivado/i2s2_2/Pmod-I2S2-Arty-S7-50.runs/reciever_cmpy_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reciever_cmpy_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reciever_cmpy_0_0.tcl
